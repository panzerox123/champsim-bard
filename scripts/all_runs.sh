...
python3 scripts/run_all_workloads.py baseline_timeout baseline "--dram-page-policy 4" >> commands.out
...
#python3 scripts/run_all_workloads.py baseline_mop4_timeout baseline_mop4 "--dram-page-policy 4" >> commands.out
...
#python3 scripts/run_all_workloads.py bard_e bard "--dram-page-policy 1 --bard-max-lookup 16 --bard-use-bitvector --bard-only-proactive-writeback" >> commands.out
#python3 scripts/run_all_workloads.py bard_c bard "--dram-page-policy 1 --bard-max-lookup 16 --bard-use-bitvector --bard-only-shadow-writeback" >> commands.out
...
python3 scripts/run_all_workloads.py bard_timeout bard "--dram-page-policy 4 --bard-max-lookup 16 --bard-use-bitvector" >> commands.out
...
#python3 scripts/run_all_workloads.py bard_mop4_timeout bard_mop4 "--dram-page-policy 4 --bard-max-lookup 16 --bard-use-bitvector" >> commands.out
...
#python3 scripts/run_all_workloads.py bard_restrict12way bard "--dram-page-policy 1 --bard-max-lookup 12 --bard-use-bitvector" >> commands.out
