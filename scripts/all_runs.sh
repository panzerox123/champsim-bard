...
#python3 scripts/run_all_workloads.py bard_close_srrip bard_close_srrip "--dram-page-policy 1" >> commands.out
#python3 scripts/run_all_workloads.py bard_close_ship bard_close_ship "--dram-page-policy 1" >> commands.out

# BARD LRU SENS
#python3 scripts/run_all_workloads.py bard_close_bitvec bard_close "--dram-page-policy 1 --bard-use-bitvector --bard-max-lookup 16" >> commands.out
