#ifndef REPLACEMENT_WLRU_SOFT_H
#define REPLACEMENT_WLRU_SOFT_H
...
class wlru_soft : public champsim::modules::replacement
{
private:
...
public:
    explicit wlru_soft(CACHE* cache);
    wlru_soft(CACHE* cache, long sets, long ways);
