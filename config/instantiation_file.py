...
pmem_fmtstr = 'champsim::chrono::picoseconds{{{clock_period_mc}}}, {{{_ulptr}}}, "{dram_type}", "{address_mapping}", {rq_size}, {wq_size}, {low_watermark}, {high_watermark}, {channels}, {bankgroups}, {banks}, {rows}, {columns}, {llc_sets}, {baws:b}, {bard_wq_abort:b}, {gwrr:b}'
